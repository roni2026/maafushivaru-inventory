...
// Canonical ordered codes per store (leading zeros stripped; DB matching uses code() function)
const BEVERAGE_ORDER = [
  ...
  '22084','14158','14161','14154','14159','14162','14163','14160','14787','31838',
  '31837','31835','31839','31836','31840','31834','31833','15036',
]
const DRY_STORE_1_ORDER = [
  '13950','14908','13627','16067','14598','14670','13668','19920','14509','13295',
  '14777','17755','16460','14087','13732','16191','16025','14044','14861','13854',
  '13928','13497','14006','17061','13666','14089','13917','15076','14626','15006',
  '15005','13593','14623','14882','14625','14184','14624','14149','14148','14147',
  '13911','14521','13913','14522','14318','14065','14597','13587','13591','13590',
  '13674','14884','15599','15892','15890','15891','15887','15888','15300','15013',
  '16083','14345','13656','14503','14856','13869','14586','14587','13984','16118',
  '14948','14585','15100','15852','14041','26703','14500','14506','15004','14129',
  '13507','14584','14504','13864','14309','15041','15139','14438','14723','14889',
  '14890','14501','14680','16474','14402','14888','14852','14581','14070','15227',
  '14602','14633','13505','13623','13253','13250','14629','13445','13254','14595',
  '13759','14288','14855','14859','14854','14437','16253','13628','13251','13949',
  '14946','14567','14088','15058','15796','14344','14789','14788','15734','13413',
  '21245','14543','13294','15297','14502','14762','15001','13665','13524','15737',
  '13518','13951','15714','13481','13729','13888','14198','15009','30098','14688',
  '13818','13570','14183','13982','13812','20525','14857','14409','14763','22104',
  '16796','13322','13997','13596','14641','15228','14611','13739','13575','14691',
  '15015','13625','13749','13624','13292','14739','15282','14858','14322','14860',
  '14967','14764','13325','14863',
]
const DRY_STORE_2_ORDER = [
  '15039','15142','13662','14531','14530','14390','14836','15727','13738','15800',
  '13619','13346','13396','14355','23267','13669','15284','21246','13881','13695',
  '13499','13572','13542','14661','13756','13578','14415','17058','14819','15047',
  '15672','13757','14042','13409','13631','14572','14435','13571','14604','13408',
  '14171','14170','14173','14169','14174','14601','13973','14594','14630','14862',
  '15102','15033','13319','14533','14532','14193','14853','13597','14398','13635',
  '14830','15593','18617','15260','13819','15140','14578','13579','15144','13711',
  '15671','13895','13715','14236','13349','13264','16306','17384','13880','17707',
  '17706','17705','13987',
]
const DRY_STORE_3_ORDER = [
  '15322','14151','15032','13335','13336','14761','13302','13990','13755','13918',
  '13912','15003','14542',
]
const FREEZER_1_ORDER = [
  '13946','13957','13963','17006','13958','28474','13969','13576','13452','13451',
  '13967','13839','14043','14119','14116','14118','14113','14115','14579','13577',
  '14690','15929','13968','13956','15975','13964','13959','15974','13290','13955',
  '14695','15973','13961','13966','13953','15117','15784','15687','13954',
]
const FREEZER_2_ORDER = [
  '15645','13360','14663','14664','13821','13464','13675','14865','14832','14913',
  '14681','14682','13602','14412','14901','14662','14228','13358','13677','14877',
  '13820','14966','17464','14292','13361','13676','13574','16288','14665','14227',
]
const STORE_ORDERS = {
  'Beverage Store': BEVERAGE_ORDER,
  'Dry Store 1':    DRY_STORE_1_ORDER,
  'Dry Store 2':    DRY_STORE_2_ORDER,
  'Dry Store 3':    DRY_STORE_3_ORDER,
  'Freezer 1':      FREEZER_1_ORDER,
  'Freezer 2':      FREEZER_2_ORDER,
}
...
function code(s) { return String(s || '').replace(/^0+/, '') || '0' }

function rowMatches(row, query) {
  if (!query.trim()) return true
  const words = query.toLowerCase().split(/\s+/).filter(Boolean)
  const hay = `${row.name} ${code(row.part_number)}`.toLowerCase()
...
async function computeAvgData(items, supabaseClient) {
  if (!items.length) return { avgMap:{}, prevMap:{} }
  const partNums = items.map(i => code(i.part_number)).filter(p => p !== '0')
  ...
  const relevant = obs.filter(o => partSet.has(code(o.part_number)))
  if (!relevant.length) return { avgMap:{}, prevMap:{} }
  const orderIds = [...new Set(relevant.map(o => o.order_id).filter(Boolean))]
  const qtyMap = new Map()
  if (orderIds.length) {
    const [{ data: oItems }, { data: rcvRecs }] = await Promise.all([
      supabaseClient.from('order_history_items').select('order_id,part_number,ordered_qty,approved_qty').in('order_id', orderIds),
      supabaseClient.from('order_receiving_records').select('order_id,part_number,received_qty').in('order_id', orderIds),
    ])
    ;(oItems||[]).forEach(oi => {
      const k = `${oi.order_id}::${code(oi.part_number)}`
      qtyMap.set(k, Number(oi.approved_qty) || Number(oi.ordered_qty) || 0)
    })
    ;(rcvRecs||[]).forEach(r => {
      const k = `${r.order_id}::${code(r.part_number)}`
      if (Number(r.received_qty) > 0) qtyMap.set(k, Number(r.received_qty))
    })
  }
  const byItem = new Map()
  relevant.forEach(o => { const k = code(o.part_number); if (!byItem.has(k)) byItem.set(k, []); byItem.get(k).push(o) })
  ...
  byItem.forEach((periods, partCode) => {
    ...
    const item = items.find(i => code(i.part_number) === partCode)
    if (!item) return
...
export default function Orders() {
  ...
  const loadItemsForStore = useCallback(async (store) => {
    ...
    if (store === 'General Order') {
      ...
      // !inner forces an INNER JOIN so only items belonging to the matching store are returned.
      // Without !inner, Supabase does a LEFT JOIN and returns ALL items (with stores=null for non-matches).
      const { data } = await supabase.from('items')
        .select('id,name,part_number,unit,current_stock,active,stores!inner(name)')
        .ilike('stores.name', `%${store}%`)
        .order('name')
      items = (data||[]).filter(i => i?.active !== false)
      // Client-side guard: keep only items whose store name contains a key word from the selected store
      // (handles edge cases where the ilike pattern is too broad)
      if (items.length) {
        const kw = store.split(/\s+/)[0].toLowerCase() // "Beverage", "Dry", "Freezer"
        const num = store.match(/\d+/)?.[0] // "1", "2", etc.
  ...
  const loadStore = useCallback(async (store) => {
    ...
    try {
      ...
      const { avgMap, prevMap } = await computeAvgData(items, supabase)
  ...
  const visibleRows = useMemo(() => rows.filter(r => rowMatches(r, search)), [rows, search])
  const orderRows   = rows.filter(r => r.ordered > 0)

  // Search full inventory for + Add Item
  const searchAllItems = useCallback(async (query) => {
    if (!query.trim()) { setAddResults([]); return }
    setAddLoading(true)
    const words = query.trim().split(/\s+/)
    // Build OR filter for each word
    const filters = words.map(w => `name.ilike.%${w}%,part_number.ilike.%${w}%`).join(',')
    const { data } = await supabase.from('items')
      .select('id,name,part_number,unit,current_stock,active,stores(name)')
      .or(filters)
      .neq('active', false).order('name').limit(25)
  ...
  // Saved order item search
  const searchSavedItems = useCallback(async (query) => {
    if (!query.trim()) { setSavedSearchResults([]); return }
    const words = query.trim().split(/\s+/)
    const filters = words.map(w => `name.ilike.%${w}%,part_number.ilike.%${w}%`).join(',')
    const { data } = await supabase.from('items')
      .select('id,name,part_number,unit,stores(name)')
      .or(filters).neq('active', false).order('name').limit(20)
    setSavedSearchResults(data || [])
  }, [])

  useEffect(() => {
    const t = setTimeout(() => searchSavedItems(savedItemSearch), 300)
    return () => clearTimeout(t)
  }, [savedItemSearch, searchSavedItems])
  ...
  const saveOrder = async () => {
    ...
    try {
      ...
      const { error: iErr } = await supabase.from('order_history_items').insert(
        orderRows.map(r => ({ order_id:order.id, item_id:r.id, part_number:r.part_number, item_name:r.name, store_name:r.store||selectedStore, unit:r.unit, ordered_qty:r.ordered, received_qty:0, approved_qty:0, item_status:'submitted' }))
      )
      if (iErr) throw iErr
      ...
      if (physRows.length) {
        ...
        delete storeItemsCache.current[selectedStore]
      }
  ...
  const exportPDF = async () => {
    ...
    try {
      ...
      autoTable(doc,{startY:36,head:[['#','Part #','Item Name','UOM','Avg/Wk','Physical','Order Qty']],
        body:orderRows.map(r=>[r.sl,code(r.part_number),r.name,r.unit,r.avgConsumption!=null?r.avgConsumption:'—',r.physStock!==''?r.physStock:'—',r.ordered]),
  ...
  const histFiltered = useMemo(() => {
    ...
    const words = histSearch.toLowerCase().split(/\s+/).filter(Boolean)
    return history.filter(o => {
      const hay = `${o.store_name||''} ${o.notes||''} ${o.delivery_date||''}`.toLowerCase()
      return words.every(w => hay.includes(w))
    })
  }, [history, histSearch])
  ...
  const exportHistoryPDF = async (order) => {
    ...
    try {
      ...
      autoTable(doc,{startY:36,head:[['SL','Part #','Item','UOM','Ordered','Approved','Received','Status']],
        body:oItems.map((oi,i)=>{const sf=Number(oi.ordered_qty)-Number(oi.received_qty);return[i+1,code(oi.part_number),oi.item_name,oi.unit,oi.ordered_qty,oi.approved_qty||'—',oi.received_qty,sf<=0?'Received':Number(oi.received_qty)>0?'Partial':'Pending']}),
        headStyles:{fillColor:cyan,fontSize:8,textColor:255},styles:{fontSize:8},alternateRowStyles:{fillColor:[248,250,252]}})
  ...
  const emailOrder = async (order) => {
    ...
    try{
      ...
      const trs=oItems.map((oi,i)=>`<tr style="background:${i%2?'#f8fafc':'#fff'}"><td style="padding:6px 10px;border-bottom:1px solid #e2e8f0;color:#64748b">${i+1}</td><td style="padding:6px 10px;border-bottom:1px solid #e2e8f0;font-family:monospace">${code(oi.part_number)}</td><td style="padding:6px 10px;border-bottom:1px solid #e2e8f0">${oi.item_name}</td><td style="padding:6px 10px;border-bottom:1px solid #e2e8f0;text-align:center">${oi.unit}</td><td style="padding:6px 10px;border-bottom:1px solid #e2e8f0;text-align:center;font-weight:700;color:#0d9488">${oi.ordered_qty}</td><td style="padding:6px 10px;border-bottom:1px solid #e2e8f0;text-align:center">${oi.approved_qty||'—'}</td></tr>`).join('')
  ...
  const openAddToSavedOrder = (orderId) => { setSavedItem(null);setSavedItemSearch('');setSavedQty('');setSavedSearchResults([]);setShowAddToOrder(orderId) }
  ...
  const saveReceiving = async(order)=>{
    ...
    try{
      for(const oi of oItems){
        ...
        await supabase.from('order_receiving_records').insert({order_id:order.id,order_item_id:oi.id,item_id:oi.item_id,part_number:oi.part_number,item_name:oi.item_name,unit:oi.unit,store_name:oi.store_name,ordered_qty:oi.ordered_qty,approved_qty:oi.approved_qty||0,received_qty:rcvQty,issue_type:issue,status:recStatus,received_by:'System'})
  ...
  const rcvHistFiltered=useMemo(()=>{
    ...
    const words=rcvHistSearch.toLowerCase().split(/\s+/).filter(Boolean)
    return rcvHistory.filter(r=>{const hay=`${r.item_name||''} ${r.part_number||''}`.toLowerCase();return words.every(w=>hay.includes(w))})
  },[rcvHistory,rcvHistSearch])

  const loadRequisitions=async()=>{
    setReqLoad(true)
    const{data}=await supabase.from('requisitions_import').select('*').order('imported_at',{ascending:false}).limit(300)
    setRequisitions(data||[])
    const{data:lastRow}=await supabase.from('requisitions_import').select('imported_at').order('imported_at',{ascending:false}).limit(1).maybeSingle()
  ...
  const syncGoogleSheet=async()=>{
    ...
    try{
      ...
      if(!resp||!resp.ok||(resp.headers.get('content-type')||'').includes('text/html')){
        toast.error('Sheet not public. Share → Anyone with link → Viewer');setSyncing(false);return
      }
      const text=await resp.text()
      if(!text.trim()){toast.error('Sheet appears empty');setSyncing(false);return}

      // Parse CSV handling quoted fields
      const parseLine=(line)=>{
        const r=[];let inQ=false,cur=''
        for(const ch of line){
          if(ch==='"'){inQ=!inQ}else if(ch===','&&!inQ){r.push(cur.trim());cur=''}else cur+=ch
        }
        r.push(cur.trim());return r
      }

      const rawRows=text.trim().split('\n').map(parseLine)
      let currentReqNum=null,newCount=0,matchedCount=0,unmatchedCount=0
      const toInsert=[]

      for(const row of rawRows){
        // Detect section header row: "Item SKU" in column C (index 2)
        const col2=(row[2]||'').trim().toLowerCase()
        if(col2==='item sku'||col2==='item_sku'||col2==='sku'||col2==='code'){
          // Extract REQ number from last columns (look for "REQ" or numeric ID)
          for(let i=row.length-1;i>=5;i--){
            const cell=String(row[i]||'').trim()
            if(!cell||cell==='-')continue
            const m=cell.match(/\d{4,}/)
            if(m){currentReqNum=m[0];break}
            if(cell.toLowerCase().includes('req')){
              const m2=cell.match(/\d+/)
              if(m2){currentReqNum=m2[0];break}
            }
          }
          continue
        }

        // Skip rows without a meaningful SKU in column C
        const rawSku=(row[2]||'').trim()
        if(!rawSku||rawSku==="#")continue
        const sku=rawSku.replace(/^0+/,'')
        const itemName=(row[3]||'').trim()
        if(!sku||!itemName)continue

        const qty=Number(String(row[4]||'').replace(/[^0-9.]/g,''))||0
        const uom=(row[5]||'').trim()
        const supplier=(row[1]||'').trim()

        // Simple hash for dedup
        const hashStr=`${currentReqNum||'?'}::${sku}::${qty}::${itemName.slice(0,20)}`
        const hash=hashStr.replace(/[^a-zA-Z0-9:]/g,'_').slice(0,120)

        const{data:ex}=await supabase.from('requisitions_import').select('id').eq('sheet_row_hash',hash).maybeSingle()
        if(ex){matchedCount++;continue}

        // Match with order_history_items by part_number
        let orderItemId=null
        if(sku){
          const{data:mi}=await supabase.from('order_history_items')
            .select('id').or(`part_number.eq.${sku},part_number.ilike.%${sku}`)
            .order('created_at',{ascending:false}).limit(1)
          orderItemId=mi?.[0]?.id||null
        }

        toInsert.push({
          sheet_row_hash:hash,
          requisition_number:currentReqNum||null,
          part_number:rawSku,
          item_name:itemName,
          unit:uom||null,
          requested_qty:qty,
          approved_qty:qty,  // In "Approved Order" sheet Qty = approved qty
          status:'approved',
          order_item_id:orderItemId,
          raw_data:{supplier,price:row[6]||''},
        })
        newCount++
      ...
      if(toInsert.length){
        ...
        for(let i=0;i<toInsert.length;i+=50){
          await supabase.from('requisitions_import').insert(toInsert.slice(i,i+50))
        }
        // Update approved_qty on matched order items
        for(const r of toInsert){
          if(r.order_item_id&&r.approved_qty>0){
            await supabase.from('order_history_items').update({approved_qty:r.approved_qty,item_status:'approved'}).eq('id',r.order_item_id)
          } else if(!r.order_item_id&&r.part_number){
            // Try matching any order_history_items with this part_number (most recent)
            const cleanSku=String(r.part_number).replace(/^0+/,'')
            await supabase.from('order_history_items')
              .update({approved_qty:r.approved_qty,item_status:'approved'})
              .or(`part_number.eq.${cleanSku},part_number.ilike.%${cleanSku}`)
              .in('item_status',['submitted','pending_approval'])
          }
        }
      }
      ...
      toast.success(`Sync done — ${newCount} new rows, ${matchedCount} matched, ${unmatchedCount} unmatched`)
      loadRequisitions()
  ...
  return (
    <div className="space-y-4">
            ...
            <>
              <div className="flex items-center gap-3 flex-wrap">
                ...
                <div className="relative flex-1 max-w-xs">
                  ...
                  <input className="input pl-8 text-xs" placeholder="Search by any word…" value={search} onChange={e=>setSearch(e.target.value)}/>
                  ...
                  <table className="w-full text-xs">
                    <thead className="border-b border-slate-700 sticky top-0 bg-slate-800 z-10">
                      <tr>
                        ...
                        <th className="px-2 py-2 text-center font-semibold text-slate-400 w-20" title="Recalculates live as you enter Physical Stock">Avg/Wk</th>
                    ...
                    <tbody className="divide-y divide-slate-700/50">
                      {visibleRows.map(row=>(
                        <tr key={row.id} className={`transition-colors ${row.ordered>0?'bg-teal-900/10 border-l-2 border-l-teal-600':'hover:bg-slate-700/20'}`}>
                          ...
                          <td className="px-2 py-1.5 font-mono text-slate-400 text-xs">{code(row.part_number)}</td>
                          <td className="px-2 py-1.5"><p className={`font-medium truncate max-w-[220px] ${row.ordered>0?'text-teal-200':'text-slate-100'}`}>{row.name}</p></td>
                            ...
                            <tbody className="divide-y divide-slate-700/30">
                              {oItems.map((oi,idx)=>{const sf=Number(oi.ordered_qty)-Number(oi.received_qty);return(
                                <tr key={oi.id} className={sf<=0?'opacity-60':''}>
                                  ...
                                  <td className="px-2 py-1 font-mono text-slate-300">{code(oi.part_number)}</td>
      ...
      {tab==='receiving'&&(
        <div className="space-y-3">
          <p className="text-xs text-slate-400">Enter received quantities. Does not affect main inventory stock.</p>
                  ...
                  <table className="w-full text-xs">
                    ...
                    <tbody className="divide-y divide-slate-700/30">
                      {oItems.map(oi=>{const inp=rcvInput[oi.id]||{qty:0,issue:'none'};return(
                        <tr key={oi.id}>
                          <td className="px-2 py-1.5 font-mono text-slate-300">{code(oi.part_number)}</td>
        ...
        <div className="space-y-3">
          ...
          {rcvHistLoad?<div className="flex justify-center py-14"><div className="w-9 h-9 border-4 border-[#00AEEF] border-t-transparent rounded-full animate-spin"/></div>
            ...
            :<div className="card overflow-hidden p-0"><div className="overflow-x-auto"><table className="w-full text-xs">
              <thead className="bg-slate-800 border-b border-slate-700 sticky top-0"><tr>{['Received','Part #','Item Name','UOM','Ordered','Approved','Rcvd Qty','Issue','Status','By'].map(h=><th key={h} className="px-2 py-2 text-left font-semibold text-slate-400 whitespace-nowrap">{h}</th>)}</tr></thead>
              <tbody className="divide-y divide-slate-700/30">{rcvHistFiltered.map(r=>(
                <tr key={r.id} className="hover:bg-slate-700/20">
                  ...
                  <td className="px-2 py-1.5 font-mono text-slate-300">{code(r.part_number)}</td>
        ...
        <div className="space-y-4">
          <div className="card-sm space-y-3">
            <div className="flex items-start justify-between gap-4 flex-wrap">
              <div>
                <p className="font-semibold text-slate-100 text-sm flex items-center gap-2"><Link className="w-4 h-4 text-[#00AEEF]"/> Google Sheet Sync — Approved Orders</p>
                <p className="text-xs text-slate-400 mt-1">Reads approved order quantities from your Google Sheet and updates the Approved column in Order History.</p>
                {lastSync&&<p className="text-xs text-slate-500 mt-1">Last sync: {fmtDateTime(lastSync)}</p>}
              </div>
              <Button onClick={syncGoogleSheet} loading={syncing}><RefreshCw className="w-3.5 h-3.5"/> Sync Now</Button>
            </div>
            <div className="text-xs text-slate-500 bg-slate-800/60 rounded-lg p-3 space-y-1 border border-slate-700/40">
              <p className="font-semibold text-slate-400">Expected Sheet format (Approved Order):</p>
              <p>Column C = Item SKU · Column D = Product Desc · Column E = Qty · Column H = REQ number</p>
              <p>Multiple sections allowed — each separated by a header row with <em>"Item SKU"</em> in column C.</p>
              <p className="mt-1"><a href={`https://docs.google.com/spreadsheets/d/${SHEET_ID}`} target="_blank" rel="noreferrer" className="text-[#00AEEF] underline underline-offset-2">Open Google Sheet</a> · Share → Anyone with link → Viewer</p>
            </div>
            {syncResult&&<div className="grid grid-cols-3 gap-2 border-t border-slate-700/50 pt-3">{[{l:'New',v:syncResult.new,c:'text-teal-400'},{l:'Matched',v:syncResult.matched,c:'text-blue-400'},{l:'Unmatched SKU',v:syncResult.unmatched,c:'text-amber-400'}].map(({l,v,c})=><div key={l} className="text-center"><p className={`text-xl font-bold ${c}`}>{v}</p><p className="text-xs text-slate-500">{l}</p></div>)}</div>}
          </div>
          {reqLoad?<div className="flex justify-center py-10"><div className="w-8 h-8 border-4 border-[#00AEEF] border-t-transparent rounded-full animate-spin"/></div>
            :requisitions.length===0?<div className="card text-center py-12 text-slate-500"><AlertTriangle className="w-10 h-10 mx-auto mb-3 opacity-20"/><p className="font-medium">No requisitions synced yet</p></div>
            :<div className="card overflow-hidden p-0"><div className="overflow-x-auto"><table className="w-full text-xs">
              <thead className="bg-slate-800 border-b border-slate-700 sticky top-0"><tr>{['REQ #','Part #','Item Name','Unit','Qty (Approved)','Status','Matched','Imported'].map(h=><th key={h} className="px-2 py-2 text-left font-semibold text-slate-400 whitespace-nowrap">{h}</th>)}</tr></thead>
              <tbody className="divide-y divide-slate-700/30">{requisitions.map(r=>(
                <tr key={r.id} className={`hover:bg-slate-700/20 ${!r.order_item_id?'opacity-60':''}`}>
                  ...
                  <td className="px-2 py-1.5 text-center">
                    {r.order_item_id?<span className="text-emerald-400 text-xs font-semibold">✓ Matched</span>:<span className="text-amber-400 text-xs">Unmatched</span>}
                  </td>
        ...
        <Modal isOpen onClose={()=>setShowAddItem(false)} title="Add Item to Order" size="sm"
          ...
          <div className="space-y-3">
            <div className="relative">
              <Search className="absolute left-2.5 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-slate-400"/>
              <input className="input pl-8 text-sm w-full" placeholder="Search by any word or part number…"
            ...
            {!addLoading&&!addSearch.trim()&&<p className="text-xs text-slate-500 text-center py-4">Type any word to search all inventory</p>}
            {addResults.length>0&&(
              <div className="max-h-72 overflow-y-auto divide-y divide-slate-700/30 border border-slate-700/50 rounded-lg">
                {addResults.map(item=>{
                  ...
                  return(<button key={item.id} onClick={()=>!already&&addItemToOrder(item)} disabled={already}
                    ...
                    <span className="font-mono text-xs text-[#00AEEF] w-16 shrink-0">{code(item.part_number)}</span>
      ...
      {/* MODAL: Add to saved history order */}
      {showAddToOrder&&(
            ...
            <div>
              ...
              {savedItem?(
                <div className="input bg-slate-700/50 flex items-center gap-2 text-sm">
                  <span className="font-mono text-xs text-[#00AEEF]">{code(savedItem.part_number)}</span>
                  <span className="flex-1 text-slate-100">{savedItem.name}</span>
                  <span className="text-slate-400 text-xs">{savedItem.unit}</span>
                  <button onClick={()=>{setSavedItem(null);setSavedItemSearch('');setSavedSearchResults([])}}><X className="w-3.5 h-3.5 text-slate-400"/></button>
                </div>
              ):(
                <div className="relative">
                  <Search className="absolute left-2.5 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-slate-400"/>
                  <input className="input pl-8 text-sm w-full" placeholder="Search by any word…" value={savedItemSearch} onChange={e=>setSavedItemSearch(e.target.value)} autoFocus/>
                </div>
              )}
              {!savedItem&&savedSearchResults.length>0&&(
                <div className="mt-1 max-h-48 overflow-y-auto divide-y divide-slate-700/30 border border-slate-700/50 rounded-lg">
                  {savedSearchResults.map(item=>(
                    <button key={item.id} onClick={()=>{setSavedItem(item);setSavedItemSearch('');setSavedSearchResults([])}}
                      className="w-full flex items-center gap-2 px-3 py-2 text-left hover:bg-slate-700/40">
                      <span className="font-mono text-xs text-[#00AEEF] w-14 shrink-0">{code(item.part_number)}</span>
                      <span className="flex-1 text-slate-200 text-sm truncate">{item.name}</span>
                    </button>
                  ))}
                </div>
